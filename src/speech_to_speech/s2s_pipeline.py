...
def build_local_pipeline(args: ParsedArguments, stop_event: Event) -> ThreadManager:
    ...
    client = RealtimeAudioClient(
        ...
        RealtimeAudioClientConfig(
            ...
            thinking_sound=local_audio.local_audio_thinking_sound,
            thinking_sound_file=local_audio.local_audio_thinking_sound_file,
            thinking_sound_gain=local_audio.local_audio_thinking_sound_gain,
            thinking_sound_delay_s=local_audio.local_audio_thinking_sound_delay,
            tools=tools,
